    ...
    ui(new Ui::mainMenu)
{
    ...
    mSplash->hide();
    mSplash->setWindowFlags(Qt::NoDropShadowWindowHint | Qt::FramelessWindowHint | Qt::WindowDoesNotAcceptFocus | Qt::WindowStaysOnTopHint | Qt::BypassWindowManagerHint);
